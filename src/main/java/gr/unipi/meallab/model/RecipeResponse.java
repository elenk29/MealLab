...
public class RecipeResponse {
    /* Εδώ αποθηκεύεται η λίστα με τα φαγητά. 
     * Την ονομάζουμε "meals" όπως και στο JSON του API https://www.themealdb.com/api/json/v1/1/search.php?s=Arrabiata */
    private List<Recipe> meals;
    // Ο άδειος κατασκευαστής επιτρέπει στη βιβλιοθήκη Jackson να δημιουργήσει το αντικείμενο.
    ...
    // Μέθοδος που χρησιμοποιεί η Jackson για να "γεμίσει" τη λίστα με τα δεδομένα που ήρθαν.
